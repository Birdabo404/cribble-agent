...
// Path settings such as WorkingDirectory= take their value literally: systemd
// does not parse quotes there, so a quoted path is rejected as "not absolute"
// and makes the whole unit fatally invalid. Only "%" specifiers need escaping.
